    ...
    <>
      ...
      {showSecretModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-md rounded-2xl border border-amber-500/40 bg-[#060d17] p-6 shadow-2xl space-y-4 relative shadow-amber-500/10">
            ...
            <div className="text-center space-y-1.5 pt-1">
              ...
              <p className="text-xs text-slate-400">
                Triple-click trigger activated. Enter credentials & Master PIN.
              </p>
            </div>
